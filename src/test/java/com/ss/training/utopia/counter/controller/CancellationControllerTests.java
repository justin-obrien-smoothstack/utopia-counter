...
public class CancellationControllerTests {
	...
	public void getCancellablyBookedFlightsTest() throws Exception {
		...
		Mockito.when(service.getCancellablyBookedFlights(travelerId)).thenReturn(flights, noFlights);
		...
		Mockito.when(service.getCancellablyBookedFlights(travelerId)).thenThrow(new RuntimeException());
